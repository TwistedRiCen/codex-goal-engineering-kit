# Historical PLAN through 8b5f025

This is historical evidence, not the current contract. Fixed-model decisions and acceptance below were superseded by model-neutral roles in 8b5f025. Consult root PLAN.md for current decisions and work.
